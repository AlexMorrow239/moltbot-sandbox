...
if (process.env.TELEGRAM_BOT_TOKEN) {
    ...
    if (telegramDmPolicy === 'open') {
        ...
        console.warn('⚠️  WARNING: Telegram dmPolicy is set to "open" - anyone can message this bot without approval.');
        console.warn('   This should only be used for local development. Use "pairing" mode in production.');
    }
}
